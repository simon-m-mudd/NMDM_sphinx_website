# -*- coding: utf-8 -*-
#
# MNDM tutorials documentation build configuration file, created by
...
project = u'MNDM tutorials'
copyright = u'2014, Simon M. Mudd'
...
htmlhelp_basename = 'MNDMtutorialsdoc'
...
latex_documents = [
  ('index', 'MNDMtutorials.tex', u'MNDM tutorials Documentation',
   u'Simon M. Mudd', 'manual'),
]
